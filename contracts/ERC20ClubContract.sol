...
contract ERC20ClubContract is Ownable, Initializable, IClubContract {
    uint256 totalIdeas;
    string public name;
    ...
    address public erc20Contract = address(0);
        ...
        initializer
    {
        ...
        (_erc20Contract, _name, _metadata) = dataDecoder(_data);
    ...
    {
        (_erc20Contract, _name, _metadata) = abi.decode(
            data,
    ...
    //     uint256 balance = IERC20(erc20Contract).balanceOf(_member);
    //     return (balance > 0);
    // }
